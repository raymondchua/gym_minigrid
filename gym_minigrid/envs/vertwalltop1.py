...
class VertWallTop1Env(MiniGridEnv):
    """
    Environment with wall sparse reward. The yellow box has a reward of 1.0 and the green box has a reward of -1.0.
    """
...
class GridworldVertWallTop1(VertWallTop1Env):
    def __init__(self):
        super().__init__(
            size=12,
...
class GridworldVertWallTop1NoGoalVis(VertWallTop1Env):
    def __init__(self):
        super().__init__(
            size=12,
            goal_pos_1=dict(x=1, y=1),
