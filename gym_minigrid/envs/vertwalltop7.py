...
class VertWallTop7Env(MiniGridEnv):
    """
    Environment with wall sparse reward. The goal is a green square at top left and top right corner with a reward of 1.0.
    """
    ...
    def _gen_grid(self, width, height):
        ...
        if self.goal_pos is not None:
            ...
            self.put_obj(
                Goal(show_goal=self.show_goal), self.size - 2, self.goal_pos["y"]
            )
...
class GridworldVertWallTop7(VertWallTop7Env):
    def __init__(self):
        super().__init__(
            size=12,
...
class GridworldVertWallTop7NoGoalVis(VertWallTop7Env):
    def __init__(self):
        super().__init__(
            size=12,
            goal_pos=dict(x=1, y=1),
...
class GridworldVertWallTop7SameStartPos(VertWallTop7Env):
    def __init__(self):
        super().__init__(
            size=12,
            goal_pos=dict(x=1, y=1),
...
class GridworldVertWallTop7NoGoalVisSameStartPos(VertWallTop7Env):
    def __init__(self):
        super().__init__(
            size=12,
            goal_pos=dict(x=1, y=1),
...
class GridworldVertWallTop7RandomGoal(VertWallTop7Env):
    def __init__(self):
        super().__init__(
            size=12,
            goal_pos=None,
...
class GridworldVertWallTop7RandomGoalNoGoalVis(VertWallTop7Env):
    def __init__(self):
        super().__init__(
            size=12,
            goal_pos=None,
