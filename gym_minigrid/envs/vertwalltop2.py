...
class VertWallTop2Env(MiniGridEnv):
    """
    Environment with wall sparse reward. The green box has a reward of 1.0 and the yellow box has a reward of -1.0.
    """
    ...
    def step(self, action):
        ...
        # Move forward
            ...
            if (
                ...
                and fwd_cell.color == "green"
            ):
                terminated = True
                reward = self._reward()

            if fwd_cell is not None and fwd_cell.type == "box" and fwd_cell.color == "yellow":
                terminated = True
                reward = -1.0
...
class GridworldDVertWallTop2(VertWallTop2Env):
    def __init__(self):
        super().__init__(
            size=12,
