...
register(
    ...
    entry_point='gym_minigrid.environments:MemoryS17Random',
)
...
register(
    ...
    entry_point='gym_minigrid.environments:MemoryS13Random',
)
...
register(
    ...
    entry_point='gym_minigrid.environments:MemoryS13',
)
...
register(
    ...
    entry_point='gym_minigrid.environments:MemoryS11',
)
...
register(
    ...
    entry_point='gym_minigrid.environments:MemoryS9',
)
...
register(
    ...
    entry_point='gym_minigrid.environments:MemoryS7',
)
