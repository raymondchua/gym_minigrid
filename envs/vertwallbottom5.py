...
class VertWallBottom5Env(MiniGridEnv):
    """
...
class GridworldVertWallBottom5(VertWallBottom5Env):
    def __init__(self):
        super().__init__(
            size=12,
...
class GridworldVertWallBottom5NoGoalVis(VertWallBottom5Env):
    def __init__(self):
        super().__init__(
            size=12,
            goal_pos=dict(x=10, y=10),
...
class GridworldVertWallBottom5View5(VertWallBottom5Env):
    def __init__(self):
        super().__init__(
            size=12, goal_pos=dict(x=10, y=10), show_goal=True, agent_view_size=5
        )


class GridworldVertWallBottom5View5NoGoalVis(VertWallBottom5Env):
    def __init__(self):
        super().__init__(
            size=12, goal_pos=dict(x=10, y=10), show_goal=False, agent_view_size=5
        )
