...
from CRLMSF.environments.gym_minigrid.roomgrid import RoomGrid
...
register(
    ...
    entry_point="gym_minigrid.environments:ObstructedMaze_1Dl",
)

register(
    id="MiniGrid-ObstructedMaze-1Dlh-v0",
    entry_point="gym_minigrid.environments:ObstructedMaze_1Dlh",
)

register(
    id="MiniGrid-ObstructedMaze-1Dlhb-v0",
    entry_point="gym_minigrid.environments:ObstructedMaze_1Dlhb",
)

register(
    id="MiniGrid-ObstructedMaze-2Dl-v0",
    entry_point="gym_minigrid.environments:ObstructedMaze_2Dl",
)

register(
    id="MiniGrid-ObstructedMaze-2Dlh-v0",
    entry_point="gym_minigrid.environments:ObstructedMaze_2Dlh",
)

register(
    id="MiniGrid-ObstructedMaze-2Dlhb-v0",
    entry_point="gym_minigrid.environments:ObstructedMaze_2Dlhb",
)

register(
    id="MiniGrid-ObstructedMaze-1Q-v0",
    entry_point="gym_minigrid.environments:ObstructedMaze_1Q",
)

register(
    id="MiniGrid-ObstructedMaze-2Q-v0",
    entry_point="gym_minigrid.environments:ObstructedMaze_2Q",
)

register(
    id="MiniGrid-ObstructedMaze-Full-v0",
    entry_point="gym_minigrid.environments:ObstructedMaze_Full",
)
