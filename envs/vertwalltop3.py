...
class VertWallTop3Env(MiniGridEnv):
    """
    ...
    def step(self, action):
        ...
        # Move forward
            ...
            if fwd_cell is not None and fwd_cell.type == "box":
                ...
                # positive reward if it is in the top left and negative reward if it is in the bottom right
                if (
...
class GridworldVertWallTop3(VertWallTop3Env):
    def __init__(self):
        super().__init__(
            size=12,
...
class GridworldVertWallTop3NoGoalVis(VertWallTop3Env):
    def __init__(self):
        super().__init__(
            size=12,
            goal_pos_1=dict(x=1, y=1),
...
register(
    id="MiniGrid-Gridworld-VertWallTop3-v0",
    entry_point="CRLMSF.environments.gym_minigrid.envs:GridworldVertWallTop3",
)

register(
    id="MiniGrid-Gridworld-VertWallTop3-NoGoalVis-v0",
    entry_point="CRLMSF.environments.gym_minigrid.envs:GridworldVertWallTop3NoGoalVis",
)
