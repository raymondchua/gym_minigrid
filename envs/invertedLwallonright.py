...
class InvertedLWallOnRightEnv(MiniGridEnv):
    """
...
class GridworldInvertedLWallOnRightGoalLeft(InvertedLWallOnRightEnv):
    def __init__(self):
        super().__init__(
...
class GridworldInvertedLWallOnRightNoGoalVisGoalLeft(InvertedLWallOnRightEnv):
    def __init__(self):
        super().__init__(
...
class GridworldInvertedLWallOnRight(InvertedLWallOnRightEnv):
    def __init__(self):
        super().__init__(
            size=12, env_id=6, goal_pos=dict(x=10, y=6), max_steps=10000, show_goal=True
        )
