...
class VertWallTop6Env(MiniGridEnv):
    """
    ...
    def _gen_grid(self, width, height):
        ...
        for i in range(2, self.size - 1):
            for j in range(2, self.size - 2):
                ...
                # check if there is object in current position
                cell = self.grid.get(*(i, j))

                # if both i and j are not even numbers, continue
                if i % 2 != 0 or j % 2 != 0:
                    continue
...
class GridworldVertWallTop6(VertWallTop6Env):
    def __init__(self):
        super().__init__(
            size=12,
...
class GridworldVertWallTop6NoGoalVis(VertWallTop6Env):
    def __init__(self):
        super().__init__(
            size=12,
            goal_pos=dict(x=1, y=1),
...
class GridworldVertWallTop6View5(VertWallTop6Env):
    def __init__(self):
        super().__init__(
            size=12,
            goal_pos=dict(x=1, y=1),
...
class GridworldVertWallTop6View5NoGoalVis(VertWallTop6Env):
    def __init__(self):
        super().__init__(
            size=12,
            goal_pos=dict(x=1, y=1),
...
register(
    id="MiniGrid-Gridworld-VertWallTop6-v0",
    entry_point="CRLMSF.environments.gym_minigrid.envs:GridworldVertWallTop6",
)

register(
    id="MiniGrid-Gridworld-VertWallTop6-NoGoalVis-v0",
    entry_point="CRLMSF.environments.gym_minigrid.envs:GridworldVertWallTop6NoGoalVis",
)

register(
    id="MiniGrid-Gridworld-VertWallTop6View5-v0",
    entry_point="CRLMSF.environments.gym_minigrid.envs:GridworldVertWallTop6View5",
)

register(
    id="MiniGrid-Gridworld-VertWallTop6View5-NoGoalVis-v0",
    entry_point="CRLMSF.environments.gym_minigrid.envs:GridworldVertWallTop6View5NoGoalVis",
)
